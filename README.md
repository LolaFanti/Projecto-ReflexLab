...
Función cargar\_datos: Se maneja el caso en el que el archivo no exista mediante un bloque try/except, devolviendo una lista vacía para evitar que el programa se detenga.
